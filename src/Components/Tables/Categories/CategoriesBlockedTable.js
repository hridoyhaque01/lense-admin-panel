...
import CategoriesConfirmationUnblockPopup from "../../Modals/Categories/CategoriesConfirmationUnblockPopup";

const CategoriesBlockedTable = ({ rows, handleSelectCheckbox }) => {
  const {
    searchBarValue,
    currentCustomer,
    setCurrentCustomer,
  ...
  return (
    <div className=" relative pb-16">
      ...
      <CategoriesConfirmationUnblockPopup
...
export default CategoriesBlockedTable;
