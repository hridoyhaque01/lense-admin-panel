...
const WarehouseConfirmationDeletePopup = ({
  currentWarehouse,
  clickHandlerForModals,
}) => {
  return (
    <section>
      <input type="checkbox" id="warehouseDeletePopup" className="modal-toggle" />
        ...
        <div className="modal-box flex flex-col items-center justify-center gap-4">
          ...
          <div>
            <p className="font-bold text-lg">
              Do you want to delete {currentWarehouse?.warehouse_name}?
            </p>
          </div>
          <div className="modal-action flex items-center justify-center">
            <label
              ...
              onClick={() => {
                clickHandlerForModals(currentWarehouse?.warehouse_id, "Deleted");
              }}
...
export default WarehouseConfirmationDeletePopup;