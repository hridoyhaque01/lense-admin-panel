...
const DeliveryConfirmationUnblockPopup = ({
  currentRider,
        ...
        <div className="modal-box flex flex-col items-center justify-center gap-4">
          ...
          <div>
            <p className="font-bold text-lg">
              Do you want to unblock {currentRider?.rider_name}?
            </p>
          </div>
          <div className="modal-action flex items-center justify-center">
            <label
              ...
              onClick={() => {
                clickHandlerForModals(currentRider?.rider_id, "Pending");
              }}
...
export default DeliveryConfirmationUnblockPopup;
