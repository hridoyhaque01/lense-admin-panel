...
const PaymentConfirmationDeletePopup = ({
  currentGateway,
  clickHandlerForModals,
}) => {
  return (
    <section>
      <input type="checkbox" id="gatewayDeletePopup" className="modal-toggle" />
        ...
        <div className="modal-box flex flex-col items-center justify-center gap-4">
          ...
          <div>
            <p className="font-bold text-lg">
              Do you want to delete {currentGateway?.gateway_name}?
            </p>
          </div>
          <div className="modal-action flex items-center justify-center">
            <label
              ...
              onClick={() => {
                clickHandlerForModals(currentGateway?.gateway_name, "Inactive");
              }}
...
export default PaymentConfirmationDeletePopup;
