...
const LocationsConfirmationDeletePopup = ({
  currentCountry,
  clickHandlerForModals,
}) => {
  return (
    <section>
      <input type="checkbox" id="locationDeletePopup" className="modal-toggle" />
        ...
        <div className="modal-box flex flex-col items-center justify-center gap-4">
          ...
          <div>
            <p className="font-bold text-lg">
              Do you want to delete {currentCountry}?
            </p>
          </div>
          <div className="modal-action flex items-center justify-center">
            <label
              ...
              onClick={() => {
                clickHandlerForModals(currentCountry, "Deleted");
              }}
...
export default LocationsConfirmationDeletePopup;
